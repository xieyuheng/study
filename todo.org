* review
- [review] [finish] Inductive Families
- [review] [finish] Do-it-yourself Type Theory
- [review] [finish] Intuitionistic Type Theory
- [review] [first part] lambda-calculus-with-types
- [review] Constructive Mathematics and Computer Programming
* paper
