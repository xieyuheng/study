- env.ext_path
- fulfill_val -- instead of fulfill_norm
- join_val
* readme
- compile to human readable javascript with runtime type information
...
- [note] is it ok to not use NormEnv in NormTelescope and NormNeuChoice ?
- string_t
